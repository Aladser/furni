<div class="sl_slider" id="slides">
			<div class="slides_container" style="overflow: hidden; position: relative; display: block;">
				<div class="slides_control" style="position: relative; width: 8955px; height: 270px; left: -2985px;"><div class="slides_control" style="position: relative; width: 8955px; height: 270px; left: -2985px; top: 0px; z-index: 5; display: block; opacity: 0.801107;"><div style="position: absolute; top: 0px; left: 2985px; z-index: 5; height: auto; display: none;">
					<div>
						<img src="content/1.jpg?1717765110304?1717769226335" alt="">
						...
						<a href="" class="sl_more">Подробнее →</a>
					</div>
				</div><div style="position: absolute; top: 0px; left: 2985px; z-index: 0; height: auto; display: none;">
					<div>
		...
		<ul class="pagination"><li class="current"><a href="#0">1</a></li><li class=""><a href="#1">2</a></li><li class=""><a href="#0">1</a></li><li><a href="#1">2</a></li><li><a href="#2">3</a></li></ul><ul class="pagination"><li><a href="#0">1</a></li><li><a href="#1">2</a></li><li><a href="#2">3</a></li></ul></div>
		...
		<div class="rw_reviewed">
			<div class="rw_slider">
				<h4>Отзывы</h4>
				<div class="caroufredsel_wrapper" style="display: block; text-align: start; float: none; position: relative; inset: auto; z-index: auto; width: 1050px; height: 216px; margin: 0px; overflow: hidden;"><div class="caroufredsel_wrapper" style="display: block; text-align: left; float: none; position: absolute; inset: 0px -3210px -50px 0px; z-index: auto; width: 1050px; height: 217px; margin: 0px; overflow: hidden;"><ul id="foo" style="text-align: left; float: none; position: absolute; inset: 0px auto auto 0px; margin: 0px; width: 4200px; height: 217px; z-index: auto;">
